 ...
 *
 * Sanitizes user data against prompt-injection before interpolation.
 * Validates that all prompts are non-empty strings.
 *
 * Closes #126
 */
...
/**
 * Strips embedded system-override patterns from user-supplied strings.
 * Prevents prompt injection by removing attempts to redefine system role.
 */
