 ...
 *
 * Role: Execute each task in the Planner's TaskPlan by calling the
 * appropriate tool functions and recording their outputs.
 *
 * Principles enforced:
 *  - P3: ALL numeric values come from tool outputs — never LLM-generated
 *  - P4: MarketContext threaded as explicit parameter
 *  - P5: Handle missing data / tool errors gracefully
 *  - P8: Market-specific tool guidance from MarketContext
...
// ── Market-specific executor guidance ───────────────────────────────
